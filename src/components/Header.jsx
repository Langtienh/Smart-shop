...
const Header = () => {
  ...
  return (
    <>
      <div className="flex justify-between items-center px-5 py-1 bg-[#d70018] text-white">
        <h2 className="font-bold text-2xl">Smart Shop</h2>
        <div>
          <Search
        ...
        <div className="flex gap-8">
          ...
          <div className="flex flex-col items-center ">
            <IoCart className="font-bold" size={24} />
